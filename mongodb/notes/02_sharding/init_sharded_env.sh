...
# connect to the first server and initiate the set
mongo --port 37017 << 'EOF'
rs.initiate({ _id: "s0", members:[
...
# add shards and enable sharding on the test db - connect to mongos
mongo <<'EOF'
...
# index on student_id must exist!!!
